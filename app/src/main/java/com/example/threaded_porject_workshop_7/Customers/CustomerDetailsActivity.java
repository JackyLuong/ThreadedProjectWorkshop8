...
public class CustomerDetailsActivity extends AppCompatActivity {
    ...
    class PutPostCustomer implements Runnable{
        ...
        public void run() {
            ...
            if(action != null && action.equals("AddCustomer")){
                ...
                method = 2; //PUT method
                 url = "http://192.168.1.65:8080/TravelExperts_Web_Services_war/api/customers/add-customer";
                ...
                url = "http://192.168.1.65:8080/TravelExperts_Web_Services_war/api/customers/post-customer";
                object = new JSONObject();
                try{
    ...
    class DeleteCustomer implements Runnable{
        ...
        public void run() {
            ...
            String url = "http://192.168.1.65:8080/TravelExperts_Web_Services_war/api/customers/delete-customer/" + customerId;
